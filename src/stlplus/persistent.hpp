...
public:
  ...
  persistent_illegal_type(unsigned short key);
...
public:
  ...
  dump_context(const otext& device, unsigned char version = PersistentVersion);
  ~dump_context(void);
  ...
  callback_data lookup_type(const std::type_info&) const;
  ...
  unsigned short lookup_interface(const std::type_info&) const;
...
public:
  ...
  restore_context(const itext& device);
  ...
  callback_data lookup_type(unsigned short) const;
  ...
  const persistent& lookup_interface(unsigned short) const;
...
void dump(dump_context&, const bool& data) ;
void restore(restore_context&, bool& data) ;
void dump(dump_context&, const char& data) ;
void restore(restore_context&, char& data) ;
void dump(dump_context&, const signed char& data) ;
void restore(restore_context&, signed char& data) ;
void dump(dump_context&, const unsigned char& data) ;
void restore(restore_context&, unsigned char& data) ;
void dump(dump_context&, const short& data) ;
void restore(restore_context&, short& data) ;
void dump(dump_context&, const unsigned short& data) ;
void restore(restore_context&, unsigned short& data) ;
void dump(dump_context&, const int& data) ;
void restore(restore_context&, int& data) ;
void dump(dump_context&, const unsigned& data) ;
void restore(restore_context&, unsigned& data) ;
void dump(dump_context&, const long& data) ;
void restore(restore_context&, long& data) ;
void dump(dump_context&, const unsigned long& data) ;
void restore(restore_context&, unsigned long& data) ;
...
void dump(dump_context&, const float& data) ;
void restore(restore_context&, float& data) ;
void dump(dump_context&, const double& data) ;
void restore(restore_context&, double& data) ;
...
void dump(dump_context&, char*& data) ;
void restore(restore_context&, char*& data) ;
...
void dump_basic_string(dump_context&, const std::basic_string<charT,traits,allocator>& data) ;
template<typename charT, typename traits, typename allocator>
void restore_basic_string(restore_context&, std::basic_string<charT,traits,allocator>& data) ;

void dump(dump_context&, const std::string& data) ;
void restore(restore_context&, std::string& data) ;
...
template<typename T>
void dump_pointer(dump_context&, const T* const data) ;

template<typename T>
void restore_pointer(restore_context&, T*& data) ;
...
template<typename T>
void dump_complex(dump_context&, const std::complex<T>& data) ;
template<typename T>
void restore_complex(restore_context&, std::complex<T>& data) ;

template<typename T>
void dump_deque(dump_context&, const std::deque<T>& data) ;
template<typename T>
void restore_deque(restore_context&, std::deque<T>& data) ;

template<typename T>
void dump_list(dump_context&, const std::list<T>& data) ;
template<typename T>
void restore_list(restore_context&, std::list<T>& data) ;

template<typename K, typename T>
void dump_pair(dump_context&, const std::pair<K,T>& data) ;
template<typename K, typename T>
void restore_pair(restore_context&, std::pair<K,T>& data) ;

template<typename K, typename T, typename P>
void dump_map(dump_context&, const std::map<K,T,P>& data) ;
template<typename K, typename T, typename P>
void restore_map(restore_context&, std::map<K,T,P>& data) ;

template<typename K, typename T, typename P>
void dump_multimap(dump_context&, const std::multimap<K,T,P>& data) ;
template<typename K, typename T, typename P>
void restore_multimap(restore_context&, std::multimap<K,T,P>& data) ;

template<typename K, typename P>
void dump_set(dump_context&, const std::set<K,P>& data) ;
template<typename K, typename P>
void restore_set(restore_context&, std::set<K,P>& data) ;

template<typename K, typename P>
void dump_multiset(dump_context&, const std::multiset<K,P>& data) ;
template<typename K, typename P>
void restore_multiset(restore_context&, std::multiset<K,P>& data) ;

template<typename T>
void dump_vector(dump_context&, const std::vector<T>& data) ;
template<typename T>
void restore_vector(restore_context&, std::vector<T>& data) ;
