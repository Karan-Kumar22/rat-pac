...
public:
  ...
  void dump(dump_context& str) const ;
  void restore(restore_context& str) ;
...
template<typename T>
void dump_simple_ptr(dump_context& str, const simple_ptr<T>& data) ;

template<typename T>
void restore_simple_ptr(restore_context& str, simple_ptr<T>& data) ;
...
template<typename T>
void dump_simple_ptr_clone(dump_context& str, const simple_ptr_clone<T>& data) ;

template<typename T>
void restore_simple_ptr_clone(restore_context& str, simple_ptr_clone<T>& data) ;
...
template<typename T>
void dump_smart_ptr(dump_context& str, const smart_ptr<T>& data) ;

template<typename T>
void restore_smart_ptr(restore_context& str, smart_ptr<T>& data) ;
...
template<typename T>
void dump_smart_ptr_clone(dump_context& str, const smart_ptr_clone<T>& data) ;

template<typename T>
void restore_smart_ptr_clone(restore_context& str, smart_ptr_clone<T>& data) ;
