...
template<typename T>
const T& simple_ptr<T>::operator*(void) const
{
  if (!m_pointer) throw null_dereference("null pointer dereferenced in simple_ptr::operator*");
  return *m_pointer;
}
...
template<typename T>
const T& simple_ptr<T>::value(void) const
{
  if (!m_pointer) throw null_dereference("null pointer dereferenced in simple_ptr::value");
  return *m_pointer;
}
...
template<typename T>
void simple_ptr<T>::dump(dump_context& context) const
{
...
template<typename T>
void simple_ptr<T>::restore(restore_context& context)
{
...
template<typename T>
T& simple_ptr_clone<T>::operator*(void)
{
...
template<typename T>
const T& simple_ptr_clone<T>::operator*(void) const
{
  if (!m_pointer) throw null_dereference("null pointer dereferenced in simple_ptr_clone::operator*");
  return *m_pointer;
}
...
template<typename T>
T& simple_ptr_clone<T>::value(void)
{
...
template<typename T>
const T& simple_ptr_clone<T>::value(void) const
{
  if (!m_pointer) throw null_dereference("null pointer dereferenced in simple_ptr_clone::value");
  return *m_pointer;
}
...
template<typename T>
void simple_ptr_clone<T>::dump(dump_context& context) const
{
  // get a magic key for the count - this also returns a flag saying whether its been seen before
  std::pair<bool,unsigned> mapping = context.pointer_map(m_count);
  // dump the magic key
...
template<typename T>
void simple_ptr_clone<T>::restore(restore_context& context)
{
  // restore the magic key
  unsigned magic = 0;
  ::restore(context,magic);
...
template<typename T>
void dump_simple_ptr_clone(dump_context& context, const simple_ptr_clone<T>& data)
{
  data.dump(context);
}

template<typename T>
void restore_simple_ptr_clone(restore_context& context, simple_ptr_clone<T>& data)
{
  data.restore(context);
}
...
template<typename T>
T& simple_ptr_nocopy<T>::operator*(void)
{
...
template<typename T>
const T& simple_ptr_nocopy<T>::operator*(void) const
{
  if (!m_pointer) throw null_dereference("null pointer dereferenced in simple_ptr_nocopy::operator*");
  return *m_pointer;
}
...
template<typename T>
T& simple_ptr_nocopy<T>::value(void)
{
...
template<typename T>
const T& simple_ptr_nocopy<T>::value(void) const
{
  if (!m_pointer) throw null_dereference("null pointer dereferenced in simple_ptr_nocopy::value");
  return *m_pointer;
}
...
template<typename T>
const T& smart_ptr<T>::operator*(void) const
{
  if (m_holder->null()) throw null_dereference("null pointer dereferenced in smart_ptr::operator*");
  return m_holder->value();
}
...
template<typename T>
const T& smart_ptr<T>::value(void) const
{
  if (m_holder->null()) throw null_dereference("null pointer dereferenced in smart_ptr::value");
  return m_holder->value();
}
...
template<typename T>
void smart_ptr<T>::dump(dump_context& context) const
{
...
template<typename T>
void smart_ptr<T>::restore(restore_context& context)
{
...
template<typename T>
T& smart_ptr_clone<T>::operator*(void)
{
...
template<typename T>
const T& smart_ptr_clone<T>::operator*(void) const
{
  if (m_holder->null()) throw null_dereference("null pointer dereferenced in smart_ptr_clone::operator*");
  return m_holder->value();
}
...
template<typename T>
T& smart_ptr_clone<T>::value(void)
{
...
template<typename T>
const T& smart_ptr_clone<T>::value(void) const
{
  if (m_holder->null()) throw null_dereference("null pointer dereferenced in smart_ptr_clone::value");
  return m_holder->value();
}
...
template<typename T>
void smart_ptr_clone<T>::dump(dump_context& context) const
{
  // Many smart pointers can point to the same object.
  // I could have used the address of the object to differentiate, 
  // but that would not have differentiated between different null smart pointers
...
template<typename T>
void smart_ptr_clone<T>::restore(restore_context& context)
{
  // get the old substructure magic key
  unsigned magic = 0;
  ::restore(context,magic);
...
template<typename T>
void dump_smart_ptr_clone(dump_context& context, const smart_ptr_clone<T>& data)
{
  data.dump(context);
}

template<typename T>
void restore_smart_ptr_clone(restore_context& context, smart_ptr_clone<T>& data)
{
  data.restore(context);
}
...
template<typename T>
T& smart_ptr_nocopy<T>::operator*(void)
{
...
template<typename T>
const T& smart_ptr_nocopy<T>::operator*(void) const
{
  if (m_holder->null()) throw null_dereference("null pointer dereferenced in smart_ptr_nocopy::operator*");
  return m_holder->value();
}
...
template<typename T>
T& smart_ptr_nocopy<T>::value(void)
{
...
template<typename T>
const T& smart_ptr_nocopy<T>::value(void) const
{
  if (m_holder->null()) throw null_dereference("null pointer dereferenced in smart_ptr_nocopy::value");
  return m_holder->value();
}
